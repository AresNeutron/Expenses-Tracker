...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', '-date'], name='api_transac_user_id_aaec0d_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['user', 'account', '-date'], name='api_transac_user_id_bcc4e7_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['user', 'category', '-date'], name='api_transac_user_id_400886_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['user', 'transaction_type', '-date'], name='api_transac_user_id_01f148_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['user', 'status', '-date'], name='api_transac_user_id_b2471e_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['account', 'status', '-date'], name='api_transac_account_5e56e0_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['category', '-date'], name='api_transac_categor_abedca_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
